...
import com.android.calendar.lecy.TimeZoneInfo
import com.android.calendar.lecy.TimeZonePickerDialog
import com.android.calendar.lecy.TimeZonePickerUtils

class GeneralPreferences : PreferenceFragment(), OnSharedPreferenceChangeListener,
        OnPreferenceChangeListener, TimeZonePickerDialog.OnTimeZoneSetListener {
...
//                mTimeZoneId, System.currentTimeMillis(), false)
        ...
        val timezoneName: CharSequence? = mTzPickerUtils?.getGmtDisplayName(getActivity(),
                            mTimeZoneId, System.currentTimeMillis())
